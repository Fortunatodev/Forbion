...
const Hero = () => {
    ...
    const badge = "Infraestrutura Digital";
    const description = "Impulsione sua empresa com nossos sistemas digitais de alta performance, projetados para otimizar operações e acelerar o crescimento.";
            ...
            <Wrapper className="relative z-10">
                <div className="flex flex-col items-center text-center">
                    ...
                    <h1 className="text-4xl md:text-6xl font-semibold tracking-tight font-heading mt-8">
                        <Balancer>
                            {"Sistemas Digitais".split(" ").map((word, index) => (
                                <motion.span
                            ...
                            <br />
                            {"Operações de Alto Padrão".split(" ").map((word, index) => (
                                <motion.span
                                    initial={{ filter: "blur(10px)", opacity: 0, y: 10 }}
                                    animate={{ filter: "blur(0px)", opacity: 1, y: 0 }}
                                    ...
                                    className={cn(
                                        "inline-block",
                                        word === "Operações" && "bg-linear-to-r from-primary via-blue-500 to-primary bg-size-[200%_100%] animate-[shimmer_3s_ease-in-out_infinite] text-transparent bg-clip-text"
                                    )}
                                    key={index}
                                >
                                    {word}&nbsp;
